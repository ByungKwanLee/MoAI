...
def hook_switcher(model, name):
    ...
    if name in ['cityscapes_fine_sem_seg_val', 'scannet_21_val_seg', 'scannet_38_val_seg', 'scannet_41_val_seg', 'sunrgbd_37_val_seg', 'context_59_val_seg', 'context_459_val_seg', 'voc_2012_val_seg', 'bdd10k_val_sem_seg', 'ade20k_full_sem_seg_val']:
        ...
        if name not in ["vlp_val", "vlp_captioning_val", "vlp_val2017", "vlp_captioning_val2017", "imagenet_val", 
                        ...
                        "refcocog_val_umd", "pascalvoc_val_Point", "grounding_coco_entity_val", "vlp_coco_entity_val", 
                        "vqav2_train", "vqav2_test", "vqav2_test-dev", "vqav2_val", "gqa_test", "gqa_testdev", "gqa_testdev_balanced", 
                        "textvqa_val", "scienceqa_test", "pope_test", "vizwiz_test", "mme", "mmbench", "mmbench_cn", "mmbench_test", "mmbench_test_cn", "llavabench", 
                        "qbench_test", "qbench_dev", "qbench_cn_test", "qbench_cn_dev", "mm-vet", "mathvista_testmini", "mathvista_test","ai2d", 
                        "mmmu_test", "mmmu_validation","chartqa", "hallusionbench", "seed"]:
