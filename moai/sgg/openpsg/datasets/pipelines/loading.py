...
from mmdet.datasets.transforms import (LoadPanopticAnnotations, LoadAnnotations, ToTensor, ImageToTensor)
...
class RelsFormatBundle(ImageToTensor):
    """Transfer gt_rels to tensor too."""
    def __call__(self, results):
        results = super().__call__(results)
        if 'gt_rels' in results:
            results['gt_rels'] = DC(ToTensor(results['gt_rels']))
