...
class AI2DDatasetMapper:
    ...
    def get_image(self, inp):
        image_file = "ai2d/ai2d_images/{}".format(inp)
    ...
    def __call__(self, dataset_dict):
        ...
        if dataset_dict['metadata']['abcLabel']:
            inp = f"abc_images/{dataset_dict['image_id']}"
        else:
            inp = f"images/{dataset_dict['image_id']}"
        image = self.get_image(inp)
