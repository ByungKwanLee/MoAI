...
class SEEDDatasetMapper:
    ...
    def from_config(cls, cfg, is_train=True, dataset_name=None):
        ...
        ret = {
            ...
            "num_classes": cfg['POPE']['INPUT']['NUM_CLASSES'],
        }
        return ret

    def get_image(self, inp):
        image_file = "SEED-Bench/SEED-Bench-image/{}".format(inp)
    ...
    def __call__(self, dataset_dict):
        ...
        image = self.get_image(dataset_dict['data_id'])
