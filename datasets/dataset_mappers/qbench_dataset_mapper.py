...
class QBenchDatasetMapper:
    ...
    def from_config(cls, cfg, is_train=True, dataset_name=None):
        ...
        ret = {
            ...
            "num_classes": cfg['MMBENCH']['INPUT']['NUM_CLASSES'],
        }
        return ret
    ...
    def get_image(self, inp):
        if inp.startswith('http') or inp.startswith('https'):
            ...
            image_file = "LLVisionQA-QBench/images/{}".format(inp)
    ...
    def __call__(self, dataset_dict):
        ...
        image = self.get_image(dataset_dict['img_path'])
