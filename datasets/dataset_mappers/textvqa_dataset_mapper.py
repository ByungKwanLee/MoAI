...
class TextVQADatasetMapper:
    ...
    def from_config(cls, cfg, is_train=True, dataset_name=None):
        ...
        ret = {
            ...
            "num_classes": cfg['TEXTVQA']['INPUT']['NUM_CLASSES'],
        }
        return ret

    def get_image(self, inp):
        image_file = "TextVQA/train_images/{}".format(inp)
    ...
    def __call__(self, dataset_dict):
        ...
        dataset_dict['image_path'] = os.path.join(_root, "TextVQA/train_images/{}".format(dataset_dict['image_id']))
