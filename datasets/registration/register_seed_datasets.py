...
_PREDEFINED_SPLITS_PRETRAIN = {
    "seed": ["SEED-Bench.json"],
}

def get_metadata(name):
    if name in ['seed']:
        return {'gt_json': os.path.join(_coco_root, 'SEED-Bench/SEED-Bench.json')}
    else:
        return {}

evaluator_mapper = {'seed': 'seed'}
...
def register_pretrain(
    ...
    semantic_name = name
    arrow_root = os.path.join(arrow_root, 'SEED-Bench')
